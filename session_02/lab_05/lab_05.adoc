...
. Congrats! You have successfully refreshed your git repo values dynamically! Next we'll learn how to register our service with a service registry and load balance requests using Spring Cloud components.
