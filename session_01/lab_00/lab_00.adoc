...
. Login to Apps Manager URL: http://run.pivotal.io. It will redirect you to the login screen. Use the same username and password you entered when using the CF CLI
+
