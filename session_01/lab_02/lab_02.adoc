...
. After login, click on your space and then click on your app. There will be an Autoscaling toggle button. Toggle it to 'On' and you will see the below screen :
+
